...
public final class EmailUtil {
    ...
    public EmailUtil(boolean debug) {
        ...
        this.mailHost =PropertiesUtil.getValueByKey("config.properties","mail.smtp.host");
        this.port = Integer.valueOf(PropertiesUtil.getValueByKey("config.properties","mail.smtp.port"));
        this.auth = Boolean.parseBoolean(PropertiesUtil.getValueByKey("config.properties","mail.smtp.auth"));
        this.sender_username = PropertiesUtil.getValueByKey("config.properties","mail.sender.username");
        this.sender_password = PropertiesUtil.getValueByKey("config.properties","mail.sender.password");
