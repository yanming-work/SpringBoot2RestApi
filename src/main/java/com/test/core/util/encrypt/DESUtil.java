...
public class DESUtil {
     ...
     * @throws Exception
     */
    public static String encrypt2(String secretKey,String plainText) throws Exception {
        Key deskey = null;
     ...
     * @throws Exception
     */
    public static String decode2(String secretKey,String encryptText) throws Exception {
        Key deskey = null;
        DESedeKeySpec spec = new DESedeKeySpec(secretKey.getBytes());
        SecretKeyFactory keyfactory = SecretKeyFactory.getInstance("desede");
        deskey = keyfactory.generateSecret(spec);
        ...
        public String encrypt(String source, String charSet)  
            ...
            encrypt = new String(Base64Util.encodeToByte(ret));  
            return encrypt;  
        }  
