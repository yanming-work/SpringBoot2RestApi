package com.test.core.util.encrypt;

import java.io.UnsupportedEncodingException;

/**
 * BlowfishUtil加密算法Java实现
 */
public class BlowfishUtil {
    ...
    private int processBlock(
            ...
            final int outOff) {
        if (workingKey == null) {
            throw new IllegalStateException("BlowfishUtil not initialised");
        }
...
/*
* (3)
* Encrypt the all-zero string with the BlowfishUtil algorithm, using
...
*
* (5)
* Encrypt the output of step(3) using the BlowfishUtil algorithm,
...
* continuously changing BlowfishUtil algorithm
*/
